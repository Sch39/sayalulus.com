...
(function( factory ){
	if ( true ) {
		// AMD
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "jquery"), __webpack_require__(/*! datatables.net-bs5 */ "./node_modules/datatables.net-buttons-bs5/node_modules/datatables.net-bs5/js/dataTables.bootstrap5.mjs"), __webpack_require__(/*! datatables.net-buttons */ "./node_modules/datatables.net-buttons-bs5/node_modules/datatables.net-buttons/js/dataTables.buttons.mjs")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ( $ ) {
...
/***/ "./node_modules/datatables.net-buttons-bs5/node_modules/datatables.net-bs5/js/dataTables.bootstrap5.mjs":
/*!**************************************************************************************************************!*\
  !*** ./node_modules/datatables.net-buttons-bs5/node_modules/datatables.net-bs5/js/dataTables.bootstrap5.mjs ***!
  \**************************************************************************************************************/
...
/***/ "./node_modules/datatables.net-buttons-bs5/node_modules/datatables.net-buttons/js/dataTables.buttons.mjs":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/datatables.net-buttons-bs5/node_modules/datatables.net-buttons/js/dataTables.buttons.mjs ***!
  \***************************************************************************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'buttons()', function ( group, selector ) {
	// Argument shifting
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'button()', function ( group, selector ) {
...
// Active buttons
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.registerPlural( 'buttons().active()', 'button().active()', function ( flag ) {
	if ( flag === undefined ) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.registerPlural( 'buttons().action()', 'button().action()', function ( action ) {
	if ( action === undefined ) {
		return this.map( function ( set ) {
...
// Collection control
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.registerPlural( 'buttons().collectionRebuild()', 'button().collectionRebuild()', function ( buttons ) {
	return this.each( function ( set ) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( ['buttons().enable()', 'button().enable()'], function ( flag ) {
	return this.each( function ( set ) {
...
// Disable buttons
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( ['buttons().disable()', 'button().disable()'], function () {
	return this.each( function ( set ) {
...
// Button index
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'button().index()', function () {
	var idx = null;
...
// Get button nodes
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.registerPlural( 'buttons().nodes()', 'button().node()', function () {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.registerPlural( 'buttons().processing()', 'button().processing()', function ( flag ) {
	if ( flag === undefined ) {
		return this.map( function ( set ) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.registerPlural( 'buttons().text()', 'button().text()', function ( label ) {
	if ( label === undefined ) {
		return this.map( function ( set ) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.registerPlural( 'buttons().trigger()', 'button().trigger()', function () {
	return this.each( function ( set ) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'button().popover()', function (content, options) {
	return this.map( function ( set ) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'buttons().containers()', function () {
	var jq = jquery__WEBPACK_IMPORTED_MODULE_0__();
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'buttons().container()', function () {
	// API level of nesting is `buttons()` so we can zip into the containers method
	return this.containers().eq(0);
} );

// Add a new button
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'button().add()', function ( idx, conf, draw ) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'buttons().destroy()', function () {
...
// Remove a button
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.registerPlural( 'buttons().remove()', 'buttons().remove()', function () {
	this.each( function ( set ) {
...
var _infoTimer;
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'buttons.info()', function ( title, message, time ) {
	var that = this;
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'buttons.exportData()', function ( options ) {
	if ( this.context.length ) {
		return _exportData( new datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api( this.context[0] ), options );
	}
} );

// Get information about the export that is common to many of the export data
// types (DRY)
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'buttons.exportInfo()', function ( conf ) {
	if ( ! conf ) {
		conf = {};
	}
...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).on( 'init.dt plugin-init.dt', function (e, settings) {
	...
	var opts = settings.oInit.buttons || datatables_net__WEBPACK_IMPORTED_MODULE_1__.defaults.buttons;
...
function _init ( settings, options ) {
	...
	var opts = options
		? options
		: api.init().buttons || datatables_net__WEBPACK_IMPORTED_MODULE_1__.defaults.buttons;

	return new Buttons( api, opts ).container();
}

// DataTables `dom` feature option
datatables_net__WEBPACK_IMPORTED_MODULE_1__.ext.feature.push( {
	fnInit: _init,
	cFeature: "B"
} );

// DataTables 2 layout feature
if ( datatables_net__WEBPACK_IMPORTED_MODULE_1__.ext.features ) {
	datatables_net__WEBPACK_IMPORTED_MODULE_1__.ext.features.register( 'buttons', _init );
}
