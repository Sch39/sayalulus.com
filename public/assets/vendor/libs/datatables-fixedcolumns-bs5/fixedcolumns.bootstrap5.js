...
(function (factory) {
    if (true) {
        // AMD
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "jquery"), __webpack_require__(/*! datatables.net-bs5 */ "./node_modules/datatables.net-fixedcolumns-bs5/node_modules/datatables.net-bs5/js/dataTables.bootstrap5.mjs"), __webpack_require__(/*! datatables.net-fixedcolumns */ "./node_modules/datatables.net-fixedcolumns-bs5/node_modules/datatables.net-fixedcolumns/js/dataTables.fixedColumns.mjs")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
            return factory($);
...
/***/ "./node_modules/datatables.net-fixedcolumns-bs5/node_modules/datatables.net-fixedcolumns/js/dataTables.fixedColumns.mjs":
/*!******************************************************************************************************************************!*\
  !*** ./node_modules/datatables.net-fixedcolumns-bs5/node_modules/datatables.net-fixedcolumns/js/dataTables.fixedColumns.mjs ***!
  \******************************************************************************************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
(function () {
     ...
     * 2019-2022 SpryMedia Ltd - datatables.net/license
     */
    setJQuery(jquery__WEBPACK_IMPORTED_MODULE_0__);
    jquery__WEBPACK_IMPORTED_MODULE_0__.fn.dataTable.FixedColumns = FixedColumns;
    jquery__WEBPACK_IMPORTED_MODULE_0__.fn.DataTable.FixedColumns = FixedColumns;
    ...
    datatables_net__WEBPACK_IMPORTED_MODULE_1__.ext.buttons.fixedColumns = {
        action: function (e, dt, node, config) {
            if (jquery__WEBPACK_IMPORTED_MODULE_0__(node).attr('active')) {
                jquery__WEBPACK_IMPORTED_MODULE_0__(node).removeAttr('active').removeClass('active');
                dt.fixedColumns().left(0);
                dt.fixedColumns().right(0);
            }
            else {
                jquery__WEBPACK_IMPORTED_MODULE_0__(node).attr('active', 'true').addClass('active');
    ...
    function _init(settings, options) {
        ...
        var opts = options
            ? options
            : api.init().fixedColumns || datatables_net__WEBPACK_IMPORTED_MODULE_1__.defaults.fixedColumns;
        var fixedColumns = new FixedColumns(api, opts);
        return fixedColumns;
    }
    // Attach a listener to the document which listens for DataTables initialisation
    // events so we can automatically initialise
    jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('plugin-init.dt', function (e, settings) {
        if (e.namespace !== 'dt') {
            return;
        }
        if (settings.oInit.fixedColumns ||
            datatables_net__WEBPACK_IMPORTED_MODULE_1__.defaults.fixedColumns) {
